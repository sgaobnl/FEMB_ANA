...
Last modified: 10/10/2017 7:17:28 PM
"""
...
def enc_allchn_pre_coh( all_chn_results, coh_chn_np, tp_no,  wire_type="All"):
    chn_enc_np = []
    #for chn in range(128):
    for chn in coh_chn_np:
        one_chn_tp = all_chn_results[chn][tp_no]
        ...
        if (wire_type == "All") and ( one_chn_tp[0][8] != "Large" ):
            enc = one_chn_tp[2][5] * one_chn_tp[1][3]
...
def sf_enc_allchn_pre_coh( all_chn_results, coh_chn_np, tp_no,  wire_type="All"):
    sf_chn_enc_np = []
    stuck_type = "Small"
    #for chn in range(128):
    for chn in coh_chn_np:
        ...
        if (wire_type == "All")  and (  stuck_free == True ):
            if (  one_chn_tp[0][2]== "Y" ) or (  one_chn_tp[0][2]== "U" ) or (  one_chn_tp[0][2]== "V" ) :
                print len(one_chn_tp[2])
                print (one_chn_tp[2])
                print len(one_chn_tp[1])
                print (one_chn_tp[1])
                enc = one_chn_tp[2][5] * one_chn_tp[1][3]

...
Last modified: 10/1/2017 11:14:27 PM
"""
...
from enc_allchn import enc_allchn
from enc_allchn import sf_enc_allchn
...
def allpedplot(ax, all_chn_results, tp_np, paras=5, wire_type="All", yrange =[000,4095], ylabel = "ADC output /bin", title = "Pedestal Measurement" ):
    paras_tp_chn = paras_tp_allchn(all_chn_results, paras=paras, wire_type=wire_type)
    patch = []
    label = []
...
def allgainplot(ax, all_chn_results, tp_np, paras=9, wire_type="All", yrange =[000,500], ylabel = "Electrons / e-", title = "Gain Measurement" ):
    paras_tp_chn = paras_tp_allchn(all_chn_results, paras=paras, wire_type=wire_type)
    patch = []
    label = []
    total_chn = len(paras_tp_chn[0])
...
def allencplot(ax, all_chn_results, tp_np, paras=6, wire_type="All",  yrange =[000,3000], ylabel = "Electrons / e-", title = "ENC Measurement" ):
...
def allencplot_stuckfree(ax, all_chn_results, tp_np, paras=6, wire_type="All",  yrange =[000,3000],ylabel = "Electrons / e-", title = "ENC Measurement" ):
    sf_enc_tp = []
    patch = []
    label = []
    for tp_no in [0,1,2,3]:
        ...
        chn_enc_np = enc_allchn(all_chn_results, tp_no, wire_type=wire_type )
        chn_np = []
        enc_np = []
        ...
        sf_chn_enc_np = sf_enc_allchn(all_chn_results, tp_no, wire_type=wire_type )
        sf_chn_np = []
        sf_enc_np = []
...
def allfft_05_plot(ax, all_chn_results, tp_np, wire_type="All", psd=True, SF = True ):
...
def all_chn_plot (all_chn_results, pp, step,env="RT", femb = 0, psd = True, gain =3):
#################################################
    ...
    tp_np = [0.5,1,2,3]
    allpedplot(ax0_0, all_chn_results, tp_np, paras=5, wire_type="All", yrange =[000,4100], ylabel = "ADC output /bin", title = "Pedestal Measurement" )
    allpedplot(ax0_1, all_chn_results, tp_np, paras=5, wire_type="Y",   yrange =[000,4100], ylabel = "ADC output /bin", title = "Pedestal Measurement" )
    allpedplot(ax0_2, all_chn_results, tp_np, paras=5, wire_type="U",   yrange =[000,4100], ylabel = "ADC output /bin", title = "Pedestal Measurement" )
    allpedplot(ax0_3, all_chn_results, tp_np, paras=5, wire_type="V",   yrange =[000,4100], ylabel = "ADC output /bin", title = "Pedestal Measurement" )
...
#################################################
    ...
    tp_np = [0.5,1,2,3]
    allgainplot(ax1_0, all_chn_results, tp_np, paras=9, wire_type="All", yrange =[000,500], ylabel = "Gain / (e-/bin)", title = "Gain Measurement" )
    allgainplot(ax1_1, all_chn_results, tp_np, paras=9, wire_type="Y",   yrange =[000,500], ylabel = "Gain / (e-/bin)", title = "Gain Measurement" )
    allgainplot(ax1_2, all_chn_results, tp_np, paras=9, wire_type="U",   yrange =[000,500], ylabel = "Gain / (e-/bin)", title = "Gain Measurement" )
    allgainplot(ax1_3, all_chn_results, tp_np, paras=9, wire_type="V",   yrange =[000,500], ylabel = "Gain / (e-/bin)", title = "Gain Measurement" )
...
#################################################
    ...
    tp_np = [0.5,1,2,3]
    enc_np_All = allencplot(ax2_0, all_chn_results, tp_np, paras=6, wire_type="All",  yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_Y   = allencplot(ax2_1, all_chn_results, tp_np, paras=6, wire_type="Y",  yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_U   = allencplot(ax2_2, all_chn_results, tp_np, paras=6, wire_type="U",  yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_V   = allencplot(ax2_3, all_chn_results, tp_np, paras=6, wire_type="V",  yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
...
#    all_tp_enc_plot(ax3_0, enc_np_All, yrange =[000,3000])
    ...
    allfft_05_plot(ax3_1, all_chn_results, tp_np, wire_type="Y", psd=True, SF = False )
    allfft_05_plot(ax3_2, all_chn_results, tp_np, wire_type="U", psd=True, SF = False )
    allfft_05_plot(ax3_3, all_chn_results, tp_np, wire_type="V", psd=True, SF = False )
    ...
    tp_np = [0.5,1,2,3]
    enc_np_All = allencplot_stuckfree(ax2_2_0, all_chn_results, tp_np, paras=6, wire_type="All", yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_Y   = allencplot_stuckfree(ax2_2_1, all_chn_results, tp_np, paras=6, wire_type="Y", yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_U   = allencplot_stuckfree(ax2_2_2, all_chn_results, tp_np, paras=6, wire_type="U", yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
    enc_np_V   = allencplot_stuckfree(ax2_2_3, all_chn_results, tp_np, paras=6, wire_type="V", yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement" )
...
#    all_tp_enc_plot(ax3_2_0, enc_np_All, yrange =[000,3000])
    ...
    allfft_05_plot(ax3_2_1, all_chn_results, tp_np, wire_type="Y", psd=True, SF = True )
    allfft_05_plot(ax3_2_2, all_chn_results, tp_np, wire_type="U", psd=True, SF = True )
    allfft_05_plot(ax3_2_3, all_chn_results, tp_np, wire_type="V", psd=True, SF = True )
    ...
    tp_np = [0.5,1,2,3]
    allpedplot(ax7_0, all_chn_results, tp_np, paras=5, wire_type="All", yrange =[000,4100], ylabel = "ADC output /bin", title = "Pedestal Measurement" )
    tp_np = [0.5,1,2,3]
    allgainplot(ax7_1, all_chn_results, tp_np, paras=9, wire_type="All", yrange =[000,500], ylabel = "Gain / (e-/bin)", title = "Gain Measurement" )
    tp_np = [0.5,1,2,3]
    ...
    enc_np_All = allencplot_stuckfree(ax7_2, all_chn_results, tp_np, paras=6, wire_type="All", yrange =[000,3000], ylabel = "ENC /e-", title = "ENC Measurement (Stuck Code Free)" )
    tp_np = [0.5,1,2,3]

...
Last modified: Fri Nov 24 19:16:15 2017
"""
...
from one_chn_result_fft import one_chn_result
from one_chn_gain import one_chn_gain
import pickle

def raw_to_result(alldata, gainfile_path, savefile, apa="ProtoDUNE", step="step001", femb=0, psd=True, env="RT", gain=3, DAC = "FPGADAC", DACvalue = [4,5,6,7,8,9,10,11], stuck_filter = True):
    all_chn_results = []
    ...
    #for chn in range(2):
        ...
        for tp_fe in [1,0,3,2]:
            ...
            rmstmp = one_chn_result(yuv_data_in=yuvdata_in, chn=chn, apa=apa, femb=femb, tp=tp_fe, psd=psd, step = step, stuck_filter = stuck_filter, env = env)

...
Last modified: Fri Nov 24 19:15:16 2017
"""
...
from raw_to_result_fft import raw_to_result

def rms_process_chn(path, wb, onedir = "step1", env = "RT", FEMB = "FEMB0",rms_smps =130000, jumbo_flag = False):
...
#gain = 3 --> 25mV/fC
    ...
    for step in step_np:
        wb = Workbook()
        FEMBNO=str(femb)
        alldata = rms_process_chn(path, wb, onedir=step, env=env, FEMB = "FEMB"+FEMBNO,rms_smps =rms_smps, jumbo_flag = jumbo_flag )

...
Last modified: Mon Jan 22 22:16:21 2018
"""
...
All_chns, X_chns, V_chns, U_chns = apa_mapping(apa=apa)
...
step_info = [ 
              [[rmsstrstep],[0,1,2,3],strenv, "WIB04"+femb_set+gainstrstep, gain, dac_np, DAC_cs, "run" + rmsstrrun, "run" + gainstrrun, "WIB04"+femb_set, intcoh_mode], 
            ]
#print   [[rmsstrstep],[0,1,2,3],strenv, "WIB5"+femb_set+gainstrstep, gain, dac_np, DAC_cs, "run" + rmsstrrun, "run" + gainstrrun, "WIB5"+femb_set] 
#step_info = [ [["38"],[1],"LN", "WIB1LNstep32", 3, [1,2,3,4], "FPGADAC", "run04" , "run04", "WIB1LNstep"], ]
#path = "/Users/shanshangao/Documents/Share_Windows/CERN_test_stand/Rawdata/Rawdata_11_09_2017/run" + runno + "/"

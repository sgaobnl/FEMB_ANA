...
Last modified: 5/3/2017 11:52:42 AM
"""
...
def paras_sf_allchn( all_chn_results,tp_no,  paras=5, wire_type="All"):
    #paras = 5: ped
    #paras = 6: rms
    #paras = 3: f for FFT
    #paras = 4: p for FFT
...
def enc_allchn( all_chn_results,tp_no,  wire_type="All"):
    chn_enc_np = []
    for chn in range(128):
        one_chn_tp = all_chn_results[chn][tp_no]

        if (wire_type == "All"):
            enc = one_chn_tp[0][6] * one_chn_tp[1][3]
...
def sf_enc_allchn( all_chn_results,tp_no,  wire_type="All"):
    sf_chn_enc_np = []
    stuck_type = "Small"
    for chn in range(128):
        one_chn_tp = all_chn_results[chn][tp_no]

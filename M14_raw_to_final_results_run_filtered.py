...
Last modified: Mon 22 Jan 2018 02:10:53 PM CET
"""
import matplotlib
matplotlib.use('Agg')
...
from S1_raw_convertion_filtered import raw_convertion 
...
#              [[rmsstrstep],[0,1,2,3],strenv, "WIB02"+femb_set+gainstrstep, gain, dac_np, DAC_cs, "run" + rmsstrrun, "run" + gainstrrun, "WIB02"+femb_set], 
              [[rmsstrstep],[3],strenv, "WIB02"+femb_set+gainstrstep, gain, dac_np, DAC_cs, "run" + rmsstrrun, "run" + gainstrrun, "WIB02"+femb_set], 
...
for step_one_info in step_info:
    ...
    for femb in step_one_info[1]:
        ...
        for step in step_np:
            ...
            result_pdfpath = path + "/" + "FEMB%d"%femb + step + "_" + DAC + "_" + 'results_filtered.pdf'
            ...
            while (os.path.isfile(result_pdfpath)):
                ...
                result_pdfpath = path + "/" + "FEMB%d"%femb +  step + "_" + DAC + "_"  + 'results_filtered' + str(save_cycle)+'.pdf'
            ...
            readfile = path +"/" + rms_step +  "FEMB%d"%femb +  step +  "_" + DAC + "_"+ "alldata_result_filtered.bin"

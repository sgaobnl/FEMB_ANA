...
Last modified: Mon Nov 27 09:15:52 2017
"""
...
from raw_convertor_m import raw_convertor_filtered
        ...
        for onefile in files:
            ...
            if (pos1 >= 0 ) and (pos2 >= 0) and (pos3 >= 0):
                ...
                if  (chip_num ==chip):
                    ...
                    chn_data = raw_convertor_filtered(raw_data, smps, jumbo_flag)
...
#gain = 3 --> 25mV/fC
    ...
    ########################################################################################
        ...
        savefile = path +"/" + "FEMB%d"%femb +  step +  "_" + DAC + "_" + "alldata_result_filtered.bin"

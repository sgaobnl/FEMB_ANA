...
Last modified: Fri Nov 24 19:22:22 2017
"""
import matplotlib
matplotlib.use('Agg')
...
from S1_raw_convertion_fft import raw_convertion 
from timeit import default_timer as timer

from one_chn_plot_fft import one_chn_plot
...
if (server_flg == "server" ):
    path_raw = "/nfs/rscratch/bnl_ce/shanshan/Rawdata/Rawdata_"+ rmsstrdate + "_2017/" 
    path_gain = "/nfs/rscratch/bnl_ce/shanshan/Rawdata/Rawdata_"+ gainstrdate + "_2017/" 
else:
    path_raw = "/Users/shanshangao/Documents/Share_Windows/CERN_test_stand/Rawdata/Rawdata_"+ rmsstrdate + "_2017/" 
    path_gain = "/Users/shanshangao/Documents/Share_Windows/CERN_test_stand/Rawdata/Rawdata_"+ gainstrdate + "_2017/"
...
#    exit()
    ...
    for femb in step_one_info[1]:
        ...
        for step in step_np:
            ...
            result_pdfpath = path + "/" + "FFT_FEMB%d"%femb + step + "_" + DAC + "_" + 'results.pdf'
            ...
            while (os.path.isfile(result_pdfpath)):
                ...
                result_pdfpath = path + "/" + "FFT_FEMB%d"%femb +  step + "_" + DAC + "_"  + 'results' + str(save_cycle)+'.pdf'
            ...
            readfile = path +"/" + rms_step +  "FEMB%d"%femb +  step +  "_" + DAC + "_"+ "alldata_result_org_fft.bin"

...
Last modified: 5/21/2017 11:51:24 AM
"""
...
def chn_rfft(chndata, fs = 2000000.0, fft_s = 5000, avg_cycle = 50):  
...
#    rms =  np.std(chndata)
    ...
    p = 20*np.log10(p)
    print "fft_sample = %d, fft_avg_num = %d"%(fft_s, avg_cycle_tmp)
    return f,p

def chn_rfft_psd(chndata, fs = 2000000.0, fft_s = 5000, avg_cycle = 50):  
    ts = 1.0/fs;# sampling interval
    len_chndata = len(chndata)
    avg_cycle_tmp = avg_cycle
#    rms =  np.std(chndata)
...
def chn_fft(chndata, fs = 2000000.0, fft_s = 5000, avg_cycle = 50):  
    ts = 1.0/fs;# sampling interval
    len_chndata = len(chndata)
#    rms =  np.std(chndata)
    avg_cycle_tmp = avg_cycle
...
def chn_fft_psd(chndata, fs = 2000000.0, fft_s = 5000, avg_cycle = 50): #power spectral density 
    ts = 1.0/fs;# sampling interval
    len_chndata = len(chndata)
#    rms =  np.std(chndata)
    avg_cycle_tmp = avg_cycle
